...
(function(global, factory) {
    if (typeof exports === "object" && exports) {
        ...
        define("/lib/mustache", [ "exports" ], factory);
    } else {
 ...
 * cookies
 */
define("/js/common/cookie", function(require, exports) {
    return {
        "get": function(name) {
        ...
        "add": function(name, v, path, expire, domain) {
            ...
            if (expire > 0) {
                var d = new Date();
                d.setTime(d.getTime() + expire * 1e3);
...
});define("/js/common/log", function(require, exports) {
    return null;
});/**
 * url
 */
define("/js/common/url", function(require, exports) {
    //给值为"?"的参数复值
    function Url(url) {
        this.para = {};
...
});define("/js/common/common", function(require, exports) {
    require("/lib/jquery");
    $.J_mustache = require("/lib/mustache");
    console.log($.J_mustache);
    $.J_cookie = require("/js/common/cookie");
    $.J_log = require("/js/common/log");
    $.J_json = JSON;
    $.J_url = require("/js/common/url");
...
define("/js/server/server", function(require, exports) {
...
});define("/js/index/index", function(require, exports) {
    require("/js/common/common");
    var baseServer = require("/js/server/server");
    /*服务器端口*/
...
});define("/js/index/main", function(require, exports) {
    var index = require("/js/index/index");
    require("/js/common/common");
    console.log($.J_mustache);
    ...
    function save(row) {
        ...
        index.translated({
            ...
            "sourceText": row.find(".source p").text(),
            "targetText": row.find(".target p").text(),
            "editor": 1
        }, function(data) {
            console.log(data);
        });
